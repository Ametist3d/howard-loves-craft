...
export default defineConfig(({ mode }) => {
  ...
  const beHost = env.BE_PROXY_HOST || '127.0.0.1';

  return {
    server: {
      // allowedHosts: ['attempts-adjustable-depot-operate.trycloudflare.com'],
      allowedHosts: ['unsimplified-dishonourably-maye.ngrok-free.dev'],
      port: fePort,
